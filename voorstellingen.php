...
<main class="py-5">
    <div class="container">
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <!-- Happy scenario voor lege tabel/database: geen PHP-warnings, maar een nette melding -->
                <div class="empty-state">
                    <div class="empty-state-icon">🎟️</div>
                    <h3>Geen voorstellingen gevonden</h3>
                    <p>Er zijn op dit moment geen voorstellingen beschikbaar die voldoen aan uw criteria.</p>
                    <?php if (!empty($search_query) || !empty($date_filter)): ?>
